...
const Navbar = () => {
  ...
  // Add a debug log to check modal states
  useEffect(() => {
    console.log('Modal states:', { verification: showVerificationModal, help: showHelpModal });
  }, [showVerificationModal, showHelpModal]);
  ...
  return (
    <>
              ...
              <div className="ml-1 sm:ml-2 flex items-center relative dropdown-container z-50">
                ...
                {isDropdownOpen && (
                  <div className="absolute right-0 top-full mt-2 w-48 sm:w-56 rounded-xl shadow-lg py-1 bg-gradient-to-br from-darkblue/90 to-darkblue-secondary/90 backdrop-blur-md border border-white/10 ring-1 ring-black ring-opacity-5 z-50 shadow-[0_0_15px_rgba(101,121,248,0.2)]">
                    <button onClick={openVerificationModal} className="flex flex-row justify-between items-center w-full px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm text-blue-300 hover:bg-gradient-to-r hover:from-blue-600/20 hover:to-purple-600/20 hover:text-white transition-colors duration-200">
                    ...
                    <button onClick={openHelpModal} className="flex flex-row justify-between items-center w-full px-3 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm text-blue-300 border-b border-white/5 hover:bg-gradient-to-r hover:from-blue-600/20 hover:to-purple-600/20 hover:text-white transition-colors duration-200">
      ...
      {/* Render modals outside of the nav element but still within the component */}
